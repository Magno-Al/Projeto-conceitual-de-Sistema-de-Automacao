...
static const struct {
    ...
    {&(RES0__INSTANCE0.VAZAO_T1), INT_P_ENUM},
    {&(RES0__INSTANCE0.VALV_ENTRADA_T1), INT_O_ENUM},
    {&(RES0__INSTANCE0.VALV_SAIDA_T1), INT_O_ENUM},
    {&(RES0__INSTANCE0.DISPLAY_T1), INT_O_ENUM},
    {&(RES0__INSTANCE0.BT_START_T2), BOOL_P_ENUM},
    {&(RES0__INSTANCE0.BT_STOP_T2), BOOL_P_ENUM},
    {&(RES0__INSTANCE0.BT_EMERG_T2), BOOL_P_ENUM},
    {&(RES0__INSTANCE0.LED_START_T2), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.NIVEL_T2), INT_P_ENUM},
